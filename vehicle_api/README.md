...
the set of services available if only low-bandwith connectivity exists, or disable certain services due to safety reasons.
...
* No support for read/write of multiple signals in a single request
